...
class NotificationChannelRule extends Model
{
    ...
    public static function defaultEventKeys(): array
    {
        return [
            ...
            'delivery_fee_proposed' => ['اقتراح رسوم توصيل', 'Delivery fee proposed', AppNotification::TYPE_SYSTEM, AppNotification::PRIORITY_HIGH, true, true, true, true, false, false, 0, 'delivery_new'],
            'delivery_fee_decided' => ['قرار رسوم التوصيل', 'Delivery fee decision', AppNotification::TYPE_SYSTEM, AppNotification::PRIORITY_NORMAL, true, true, true, true, false, false, 0, 'delivery_new'],
            'shipping_company_assigned' => ['طلب شحن جديد', 'New shipping request', AppNotification::TYPE_SYSTEM, AppNotification::PRIORITY_HIGH, true, true, true, true, false, false, 0, 'delivery_new'],
            'shipping_update' => ['تحديث الشحن', 'Shipping update', AppNotification::TYPE_SYSTEM, AppNotification::PRIORITY_NORMAL, true, true, true, true, false, false, 0, 'delivery_new'],
            ...
            'staff_invited' => ['دعوة للانضمام كموظف', 'Staff invitation', AppNotification::TYPE_SYSTEM, AppNotification::PRIORITY_HIGH, true, true, true, true, false, false, 0, 'system'],
            'staff_accepted' => ['قبول دعوة الموظف', 'Staff invitation accepted', AppNotification::TYPE_SYSTEM, AppNotification::PRIORITY_NORMAL, true, true, true, true, false, false, 0, 'system'],
            'staff_declined' => ['رفض دعوة الموظف', 'Staff invitation declined', AppNotification::TYPE_SYSTEM, AppNotification::PRIORITY_NORMAL, true, true, true, true, false, false, 0, 'system'],
            ...
            'trip_run_stop_arrived' => ['وصول المركبة إلى نقطة توقف', 'Vehicle arrived at a stop', AppNotification::TYPE_SYSTEM, AppNotification::PRIORITY_NORMAL, true, true, true, true, false, false, 0, 'booking_confirmed'],
            ...
            'training_lapse' => ['انقطاع متدرب عن تمارينه', 'Client fell behind', AppNotification::TYPE_SYSTEM, AppNotification::PRIORITY_NORMAL, true, true, true, true, false, false, 0, 'system'],
