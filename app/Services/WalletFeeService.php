...
class WalletFeeService
{
    ...
    protected function createWalletFeeTransaction(
        ...
        $transaction = WalletTransaction::create([
            ...
            'note' => $this->buildHumanNote($feeCode, $payer, $booking, $line, $loyalty),
    ...
    protected function buildHumanNote(string $feeCode, string $payer, Booking $booking, array $line = [], array $loyalty = []): string
    {
        $serviceName = (string) (
