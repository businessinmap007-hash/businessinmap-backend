...
final class BusinessCapability
{
     ...
     * مثلًا لا يحتاج متابعةَ مشاريع — فمُنحت خدمةَ منصّةٍ حقيقية («projects»
     * فى platform_services) بدلًا من حدسٍ فى الكود. التوزيعُ الفعلى لأى فئةٍ
     * تملكها معلّقٌ لجلسةٍ قادمة مخصّصة لذلك؛ حتى تُدخَل تلك الصفوف فى
     * category_platform_services، يظهر «المشاريع» لمن يملك الصفَّ فقط —
     * وهذا فراغٌ مؤقّتٌ متوقَّعٌ لا خطأ.
     */
