...
/**
 * Phase 4 — single-source the deposit config. The booking engine already
 * resolves deposit solely from `business_deposit_policies`; these per-price
 * columns only fed a display/snapshot path that could disagree with what was
 * actually held. Retire them so deposit has exactly one source.
 */
