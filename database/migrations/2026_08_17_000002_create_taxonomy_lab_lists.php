 ...
 * places one atom into a list, and the atom may come from EITHER source we work
 * with — an option (`options_new`) or a service item type
 * (`platform_service_item_types_new`) — which is the whole point: one list can
 * unify what used to be split across the two systems.
 *
...
return new class extends Migration
{
    public function up(): void
    {
        ...
        Schema::create('lab_list_items', function (Blueprint $table) {
            ...
            $table->enum('source', ['option', 'item_type']);
