...
return [
    ...
    */
    'links' => [
        ...
        // ── the gypsum trades, one list, sliced per child ────────────────
        // «جبسيوم بورد» #132 و«جبس وكرانيش» #134 — hard-deleted by the owner
        // 2026-08-26 (rootless list review).
        133 => ['أعمال الجبس والأسقف' => ['جبس بورد', 'أسقف معلقة', 'كرانيش', 'ديكورات جبسية', 'إضاءة مخفية', 'ترميم جبس'], 'نظام التعاقد' => ['يومي', 'بالمهمة']],
        129 => ['أعمال الجبس والأسقف' => ['جي أر سي', 'واجهات جي أر سي', 'ديكورات جبسية'], 'نظام التعاقد' => ['يومي', 'بالمهمة']],

        // ── the four building trades ─────────────────────────────────────
        147 => ['أعمال البناء والمحارة' => ['مباني طوب', 'محارة وبياض', 'خرسانات', 'أساسات'], 'نظام التعاقد' => ['يومي', 'بالمهمة']],
        ...
        179 => ['أعمال البناء والمحارة' => ['واجهات حجرية', 'حجر هاشمي', 'نحت وتشكيل', 'ترميم مباني'], 'نظام التعاقد' => ['يومي', 'بالمهمة']],
        // Half the demolition jobs on a finished building are a core drill.
        80 => ['أعمال البناء والمحارة' => ['تكسير وإزالة', 'نحت وتشكيل', 'قص وتخريم خرسانة'], 'نظام التعاقد' => ['يومي', 'بالمهمة']],

        // ── the two flooring trades ──────────────────────────────────────
        106 => ['أعمال الأرضيات' => ['سيراميك وبورسلين', 'رخام وجرانيت', 'وزر وحوائط', 'ترميم أرضيات'], 'نظام التعاقد' => ['يومي', 'بالمهمة']],
        208 => ['أعمال الأرضيات' => ['باركيه', 'HDF', 'أرضيات فينيل', 'إبوكسي', 'نجيل صناعي', 'ترميم أرضيات'], 'نظام التعاقد' => ['يومي', 'بالمهمة']],

        // ── the nine borrowings ──────────────────────────────────────────

        // A carpenter is a furniture workshop with one bench.
        49 => ['تخصصات ورش الأثاث' => 'all', 'نظام التعاقد' => ['يومي', 'بالمهمة']],

        287 => ['تخصصات ورش الأثاث' => ['تنجيد', 'كنب وركنات', 'ترميم وإصلاح أثاث'], 'نظام التعاقد' => ['يومي', 'بالمهمة']],
        ...
        299 => ['تخصصات ورش الأثاث' => ['حفر وأويما', 'ديكورات خشبية', 'أرابيسك ومشربية'], 'نظام التعاقد' => ['يومي', 'بالمهمة']],
        ...
        15 => ['تخصصات ورش الأجهزة' => ['صيانة تبريد وتكييف', 'شحن فريون', 'تركيب أجهزة', 'صيانة دورية'], 'نظام التعاقد' => ['يومي', 'بالمهمة', 'بالزيارة']],
         ...
         */
        22 => ['تخصصات ورش الأجهزة' => 'all', 'نظام التعاقد' => ['يومي', 'بالمهمة', 'بالزيارة']],

        174 => ['أعمال الأرضيات' => ['رخام وجرانيت', 'وزر وحوائط', 'ترميم أرضيات'], 'نظام التعاقد' => ['يومي', 'بالمهمة']],


        /*
         * ── «باليومية ولا بالمقاولة» ─────────────────────────────────────
         *
         * «راجع باقي أبناء الحرف والمهن بنفس الطريقة» — owner, 2026-08-16, and
         * the root came back clean on every axis this sweep has been checking:
         * twenty-five children, none mute, none promoted, every one holding a
         * real `line`. What none of them held was the axis their whole trade is
         * negotiated on.
         *
         * A نقاش with 35 merchants could say «دهان بلاستيك» and not whether he
         * charges by the day or for the job — which in Egypt is the first
         * question anybody asks a craftsman and the one the price turns on. The
         * offices root has had «نظام التعاقد» since it was written; the crafts
         * were given lines that day and never the basis.
         *
         * Two rows for everybody, because those are the two answers. Not
         * «بالساعة» — nobody hires a plasterer by the hour — and not the
         * subscription rungs, which are an office's shape. A third for the five
         * CALL-OUT trades (صيانة تكيف، صيانة أجهزة، كهربائي، سباك، دش): a visit
         * that diagnoses and may fix is priced as a visit.
         *
         * The children that already had an entry got it appended INSIDE theirs.
         * A second `%d =>` key would be silent and would keep only the last —
         * which is what this file's own note two blocks up warns about, and what
         * the first attempt at this change did.
         */
        75 => ['نظام التعاقد' => ['يومي', 'بالمهمة']],
        89 => ['نظام التعاقد' => ['يومي', 'بالمهمة', 'بالزيارة']],
        136 => ['نظام التعاقد' => ['يومي', 'بالمهمة']],
        206 => ['نظام التعاقد' => ['يومي', 'بالمهمة']],
        227 => ['نظام التعاقد' => ['يومي', 'بالمهمة', 'بالزيارة']],
        251 => ['نظام التعاقد' => ['يومي', 'بالمهمة', 'بالزيارة']],
    ],
];
