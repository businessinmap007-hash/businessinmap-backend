...
return [
    ...
    'splits' => [
        ...
        /*
        | ── الترفيه: فئةُ الجهاز ليست غرفةً تُؤجَّر ─────────────────────────
        |
        | «فئة جهاز الألعاب» #459 تجيب سؤالًا واحدًا: أىُّ جهازٍ فى هذه الساعة —
        | بلايستيشن ٤ أم ٥ أم إكس بوكس. و«غرفة خاصة» #1929 وقعت بينها فى
        | 2026-08-19 04:13، وهى ليست فئةَ جهاز: هى المكانُ الذى يُستأجر،
        | والجهازُ يوصَف داخلَه.
        |
        | والأثر لم يكن تجميليًّا: `entertainment_child_vocabularies.php` يعلنها
        | تحت «ألعاب ومرافق الترفيه» #458 ويربطها بأربعة أبناء — بلياردو،
        | بلايستيشن، مركز ترفيهي، إنترنت كافيه — فكانت البذرةُ تعيد وصلَها كل
        | تشغيل واختبارُ ثباتها أحمر. ملفّان يتنازعان، والرابحُ آخرُ من يجرى.
        |
        | وهذا الملف هو صاحبُ القول فى أىِّ مجموعةٍ يسكن خيار، فالحكمُ يُكتب هنا
        | لا بتحديثٍ يدوىٍّ يُنسى. قرار المالك 2026-08-19.
        */
        'فئة جهاز الألعاب' => [
            'into_existing' => [
                'ألعاب ومرافق الترفيه' => [1929], // غرفة خاصة
            ],
        ],
