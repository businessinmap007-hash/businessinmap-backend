    ...
    <div class="a2-card">
        ...
        <div class="a2-field">
            ...
            <select class="a2-select" name="owner_business_id" required>
                ...
                @foreach($businesses as $business)
                    <option value="{{ $business->id }}" {{ (int) old('owner_business_id', $partnership->owner_business_id) === (int) $business->id ? 'selected' : '' }}>
        ...
        <div class="a2-field">
            ...
            <select class="a2-select" name="partner_business_id" required>
                ...
                @foreach($businesses as $business)
                    <option value="{{ $business->id }}" {{ (int) old('partner_business_id', $partnership->partner_business_id) === (int) $business->id ? 'selected' : '' }}>
                        #{{ $business->id }} — {{ $business->name }}
                    </option>
                @endforeach
            </select>
