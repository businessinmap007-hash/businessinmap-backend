...
<div class="a2-page">
    <div class="a2-page-head">
        <div>
            ...
            <div class="a2-page-subtitle">{{ __('إدارة خصائص المنتجات مثل اللون، الحجم، السعة، الخامة، النوع.') }}</div>
        </div>
    </div>
    ...
    <div class="a2-card">
        <form method="GET" action="{{ route('admin.catalog-attributes.index') }}" class="a2-filterbar">
            ...
            <div class="a2-filter-actions">
                ...
                <a class="a2-btn a2-btn-ghost" href="{{ route('admin.catalog-attributes.index') }}">{{ __('تفريغ') }}</a>
            </div>
        </form>
        ...
        <div class="a2-table-wrap">
            <table class="a2-table">
                ...
                <tbody>
                    ...
                    @empty
                        <tr>
                            <td colspan="9" class="a2-empty-cell">{{ __('لا يوجد بيانات') }}</td>
                        </tr>
                    @endforelse
                </tbody>
            </table>
