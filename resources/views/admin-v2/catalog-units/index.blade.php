...
@section('title', 'Catalog Units')
@section('body_class', 'admin-v2-catalog-units')
...
<div class="a2-page">
    ...
    <div class="a2-stat-grid a2-mb-16">
        <div class="a2-stat-card">
            <div class="a2-stat-label">Total Units</div>
    ...
    <div class="a2-card">
        <form method="GET" action="{{ route('admin.catalog-units.index') }}" class="a2-filterbar">
            <input class="a2-input a2-filter-search" name="q" value="{{ $qVal }}" placeholder="Search: name / symbol / code">
