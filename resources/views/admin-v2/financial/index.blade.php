...
<div class="a2-page">
  <div class="a2-card">
    ...
    {{-- Filters --}}
    <form method="GET" action="{{ route('admin.financial.index') }}" class="a2-filterbar">
      <input class="a2-input a2-filter-search" type="search" name="q" value="{{ $qVal }}" placeholder="{{ __('بحث بـ ID أو user_id أو amount أو ref') }}">
