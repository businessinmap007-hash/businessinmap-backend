...
<div class="a2-form-grid">
    <div class="a2-card">
        ...
        <div class="a2-field">
            <label class="a2-label">{{ __('الكود') }}</label>
        ...
        <div class="a2-field">
            <label class="a2-label">{{ __('نوع الفئة') }}</label>
            <select class="a2-select" name="target_type" required>
                <option value="client" {{ old('target_type', $level->target_type) === 'client' ? 'selected' : '' }}>{{ __('عميل') }}</option>
                <option value="business" {{ old('target_type', $level->target_type) === 'business' ? 'selected' : '' }}>{{ __('نشاط') }}</option>
            </select>
        </div>
    ...
    <div class="a2-card">
        ...
        <div class="a2-field">
            <label class="a2-label">{{ __('المبلغ المطلوب تجميده') }}</label>
        ...
        <div class="a2-field">
            <label class="a2-label">{{ __('تغطية قيد الانتظار') }}</label>
        ...
        <div class="a2-field">
            <label class="a2-label">{{ __('التغطية الفعّالة') }}</label>
    ...
    <div class="a2-card">
        ...
        <div class="a2-field">
            <label class="a2-label">{{ __('مبلغ تعزيز التغطية') }}</label>
        ...
        <div class="a2-field">
            <label class="a2-label">{{ __('التعزيز: أدنى عمليات مكتملة') }}</label>
        ...
        <div class="a2-field">
            <label class="a2-label">{{ __('التعزيز: أدنى نسبة نجاح %') }}</label>
        ...
        <div class="a2-field">
            <label class="a2-label">{{ __('التعزيز: أقصى نسبة نزاعات %') }}</label>
    ...
    <div class="a2-card">
        ...
        <div class="a2-field">
            <label class="a2-label">{{ __('العمليات المكتملة المطلوبة') }}</label>
        ...
        <div class="a2-field">
            <label class="a2-label">{{ __('درجة الثقة المطلوبة') }}</label>
        ...
        <div class="a2-field">
            <label class="a2-label">{{ __('أقصى نزاعات خاسرة') }}</label>
        ...
        <div class="a2-field">
            <label class="a2-label">{{ __('أقصى إلغاءات متأخرة') }}</label>
    ...
    <div class="a2-card">
        <h2 class="a2-section-title">{{ __('بيانات إضافية (JSON)') }}</h2>

        <div class="a2-field">
            <label class="a2-label">{{ __('بيانات إضافية') }}</label>
