...
<div class="a2-page">
    <div class="a2-page-head">
        <div>
            <h1 class="a2-page-title">{{ __('إنشاء مستوى ضمان') }}</h1>
            <div class="a2-page-subtitle">{{ __('إضافة مستوى جديد للعميل أو صاحب العمل مع تحديد قدرة التغطية وشروط التأهيل.') }}</div>
        </div>
