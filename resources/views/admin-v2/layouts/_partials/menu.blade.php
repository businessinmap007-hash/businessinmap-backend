@php
    ...
    $menu = [
        ...
        */
        ['label' => 'الخدمات', 'route' => 'admin.child-workbench.index', 'icon' => 'settings', 'active' => ['admin.child-workbench.', 'admin.service-components.', 'admin.categories.services-bulk.', 'admin.category-child-service-fees.', 'admin.platform-services.', 'admin.platform-service-item-types.', 'admin.platform-service-item-groups.', 'admin.service-branches.', 'admin.service-catalog-matrix.', 'admin.business_service_prices.', 'admin.fee-groups.', 'admin.platform-service-fee-promotions.', 'admin.bookings.', 'admin.bookable-items.', 'admin.bookable-allocations.', 'admin.menu-review.', 'admin.menu-items.', 'admin.business-tables.', 'admin.delivery.', 'admin.trip-schedules.', 'admin.training-plans.', 'admin.clinic-appointments.', 'admin.prescriptions.', 'admin.agenda.', 'admin.projects.'], 'children' => [
            ...
            ['label' => 'التدريب والعيادات والمشاريع', 'type' => 'section', 'children' => [
                ...
                ['label' => 'الوصفات الطبية (إشراف)', 'route' => 'admin.prescriptions.index', 'active' => 'admin.prescriptions.'],
        ...
        */
        ...
        ['label' => 'المحتوى', 'route' => 'admin.posts.index', 'icon' => 'file', 'active' => ['admin.posts.', 'admin.jobs.', 'admin.job-follows.', 'admin.job-titles.', 'admin.exercise-library.', 'admin.albums.', 'admin.medicines.'], 'children' => [
            ...
            ['label' => 'مكتبة التمارين', 'route' => 'admin.exercise-library.index', 'active' => 'admin.exercise-library.'],
        ...
        ['label' => 'إعدادات التطبيق', 'route' => 'admin.payment-settings.edit', 'icon' => 'settings', 'active' => ['admin.payment-settings.', 'admin.merchant-payment-accounts.', 'admin.merchant-account-requests.', 'admin.push-settings.', 'admin.admin-roles.', 'admin.arbitrators.', 'admin.dispute-rules.', 'admin.dispute-fees.', 'admin.chat-access-settings.'], 'children' => [
            ...
            ['label' => 'الاطلاع على المحادثات', 'route' => 'admin.chat-access-settings.edit', 'active' => 'admin.chat-access-settings.'],
        ]],
    ];
