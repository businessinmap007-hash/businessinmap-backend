@php
    ...
    $menu = [
        ...
        ['label' => 'إعدادات التطبيق', 'route' => 'admin.payment-settings.edit', 'icon' => 'settings', 'active' => ['admin.payment-settings.', 'admin.push-settings.', 'admin.admin-roles.', 'admin.arbitrators.', 'admin.dispute-rules.'], 'children' => [
