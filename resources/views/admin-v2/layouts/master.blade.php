...
<body class="a2-page admin-v2 @yield('body_class')">
    ...
    <div class="a2-main">
        ...
        <header class="a2-topbar">
            <div class="a2-topbar-left">
                <button class="a2-burger a2-burger--mobile" type="button" id="a2OpenSidebar" aria-label="Open Menu">
                    ☰
                </button>
...
(function(){
  ...
  function openMobile(){ body.classList.add('a2-sidebar-open'); }
  function closeMobile(){ body.classList.remove('a2-sidebar-open'); }
  function toggleMini(){ body.classList.toggle('a2-sidebar-mini'); }
  function enableMini(){ body.classList.add('a2-sidebar-mini'); }
