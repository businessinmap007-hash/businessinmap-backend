...
<div class="a2-page">
    <div class="a2-page-head">
        <div>
            <h1 class="a2-page-title">تفعيل Boost لعرض</h1>
            <div class="a2-page-subtitle">اختيار عرض وباقة، ثم خصم قيمة الباقة من محفظة البزنس صاحب العرض.</div>
        </div>
        <div class="a2-page-actions">
            <a href="{{ route('admin.offer-boost-packages.index') }}" class="a2-btn a2-btn-ghost">باقات Boost</a>
    ...
    <div class="a2-card a2-mb-16">
        <form method="GET" action="{{ route('admin.offer-boost-packages.boost-form') }}" class="a2-filterbar">
            <select class="a2-select a2-filter-search" name="offer_id">
                <option value="0">اختر عرضًا</option>
            ...
            <button class="a2-btn a2-btn-primary" type="submit">عرض التفاصيل</button>
        </form>
    </div>
    ...
    @if($offer)
        <div class="a2-grid-2">
            <div class="a2-card">
                <h2 class="a2-section-title">العرض المحدد</h2>
            ...
            <div class="a2-card">
                <h2 class="a2-section-title">تفعيل الباقة</h2>
                <form method="POST" action="{{ route('admin.offer-boost-packages.activate') }}">
                    ...
                    <button class="a2-btn a2-btn-primary" type="submit">تفعيل وخصم الرسوم</button>
                </form>
            </div>
        </div>
    @else
        <div class="a2-card">
            <div class="a2-empty-cell">اختر عرضًا أولًا لتفعيل Boost.</div>
        </div>
    @endif
</div>
@endsection
