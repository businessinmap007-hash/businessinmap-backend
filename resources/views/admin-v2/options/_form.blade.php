<div class="a2-card a2-card--section">
    <div class="a2-card-head">
        <div>
            <div class="a2-card-title">{{ __('بيانات الخيار') }}</div>
            <div class="a2-card-sub">{{ __('الاسم العربي والإنجليزي') }}</div>
        </div>
    </div>
...
<div class="a2-page-actions" style="justify-content:flex-end;margin-top:16px;">
    <a href="{{ route('admin.options.index') }}" class="a2-btn a2-btn-ghost">{{ __('رجوع') }}</a>
