...
@section('title', __('إضافة عرض رسوم منصة'))
...
<div class="a2-page">
    <div class="a2-page-head">
        <div>
            <h1 class="a2-page-title">{{ __('إضافة عرض رسوم منصة') }}</h1>
            <div class="a2-page-subtitle">
                {{ __('إنشاء عرض مؤقت لتعديل أو إيقاف رسوم المنصة بدون تغيير القيم الأصلية.') }}
            </div>
        </div>
