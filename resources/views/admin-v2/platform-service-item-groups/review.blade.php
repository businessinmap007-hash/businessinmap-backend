...
@php
    $sections = [
        'unused' => [
            ...
            'note' => __('لا يسمح به إعداد أي ابن، فلا يراه تاجر أصلًا. هذه هي المجموعة المطلوبة للمراجعة اليدوية — للنظر فيها، لا لحذفها.'),
            'pill' => 'a2-pill-gray',
        ],
        'offered' => [
            'title' => __('معروض ولم يُستخدم بعد'),
            'note' => __('أبناء يسمحون به، لكن لا تاجر سعّر فيه صفًا ولا أدرج وحدة. قسم لم يُملأ بعد، لا قسم ميت.'),
            'pill' => 'a2-pill-gray',
        ],
        'in_use' => [
...
<div class="a2-page">
    ...
    <div class="a2-alert a2-alert-info">
        <strong>{{ __('نحن لا نحذف الفروع.') }}</strong>
        {{ __('خلوّ الفرع من الحسابات ليس سببًا لحذفه — قد يكون قسمًا لم يُفتح بعد. هذه الشاشة للقراءة فقط، وهي تقول أين وصل كل فرع لا ما يستحقه.') }}
    </div>
