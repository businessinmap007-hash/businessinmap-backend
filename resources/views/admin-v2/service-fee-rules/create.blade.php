...
@section('title', __('قاعدة رسوم جديدة'))
@section('topbar_title', __('قاعدة رسوم جديدة'))
...
<div class="a2-page">
    <div class="a2-page-head">
        <div>
            <h1 class="a2-page-title">{{ __('قاعدة رسوم جديدة') }}</h1>
            <div class="a2-page-subtitle">{{ __('تُطبَّق على الرسوم الأساسية بعد حسابها، قبل أي عرض خصم.') }}</div>
        </div>
