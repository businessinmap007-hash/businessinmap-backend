...
@php
    ...
    $consent = $user->serviceFeeConsent ?? null;

    $feeAutoChargeEnabled = (bool) optional($consent)->fee_auto_charge_enabled;
    $ratingEnabled = (bool) optional($consent)->rating_enabled;
    $statsEnabled = (bool) optional($consent)->stats_enabled;
...
<div class="a2-page a2-page-narrow">
    ...
    <div class="a2-card">
        ...
        <div class="a2-form-grid-3">
            <div>
                <label class="a2-label">Wallet Balance</label>
            ...
            <div>
                <label class="a2-label">Locked Balance</label>
                <div class="a2-view-field">
                    {{ number_format((float)($wallet->locked_balance ?? 0), 2) }}
                </div>
            </div>

            <div>
                <label class="a2-label">Wallet Status</label>
                <div class="a2-view-field">{{ $wallet->status ?? '—' }}</div>
            </div>
            ...
            <div>
                ...
                <div class="a2-view-field">
                    ...
                    @else
                        <span class="a2-pill a2-pill-gray">Disabled</span>
                    @endif
                </div>
            </div>
            ...
            <div>
                <label class="a2-label">Enabled At</label>
                <div class="a2-view-field">
                    {{ optional($consent?->enabled_at)->format('Y-m-d H:i') ?: '—' }}
                </div>
            </div>

            <div>
                <label class="a2-label">Disabled At</label>
                <div class="a2-view-field">
                    {{ optional($consent?->disabled_at)->format('Y-m-d H:i') ?: '—' }}
                </div>
            </div>

            <div>
                <label class="a2-label">Consent ID</label>
                <div class="a2-view-field">{{ $consent->id ?? '—' }}</div>
            </div>
        </div>
