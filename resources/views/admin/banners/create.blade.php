...
@endsection
@section('content')
    <form id="storeCampaign" method="POST" action="{{ route('banners.store') }}" enctype="multipart/form-data"
    ...
    <!-- Page-Title -->
        <div class="row">
            <div class="col-lg-10 col-sm-offset-1">
                ...
                <h4 class="page-title">إدارة البانرات الإعلانية</h4>
            </div>
        </div>
        ...
        <div class="row">
            <div class="col-lg-10 col-sm-offset-1">
                <div class="card-box">
                    <h2 class="header-title m-t-0 m-b-30">إضافة بانر إعلاني </h2>
