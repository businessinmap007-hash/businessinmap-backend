    ...
    <div class="row">
        <div class="col-sm-12">
            <div class="btn-group pull-right m-t-15 ">
                <a href="{{ route('banners.create') }}" type="button" class="btn btn-custom waves-effect waves-light"
                   aria-expanded="false">
                <span class="m-l-5">
                        ...
                        <tr>
                            ...
                            <td>
                                ...
                                <a href="{{ route('banners.edit', $row->id) }}"
                                   ...
                                   data-original-title="تعديل البنر"
