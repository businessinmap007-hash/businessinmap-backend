    ...
    <div class="row">
        <div class="col-sm-10 col-sm-offset-1">
            <div class="btn-group pull-right m-t-15 ">
                <a href="{{ route('coupons.create') }}" type="button" class="btn btn-custom waves-effect waves-light"
                   aria-expanded="false">
                <span class="m-l-5">
            ...
            <div class="card-box table-responsive">
                ...
                <table id="datatable-fixed-header" class="table table-striped table-bordered dt-responsive nowrap"
                    ...
                    <tr>
                        ...
                        <th>كود الخصم</th>
                        <th>الهدية</th>
                        <th>عدد الاستخدمات</th>
                        <th>الحد الادني للاستخدام</th>
                        <th>القسم</th>
                    ...
                    @foreach($results as $key => $row)
                        <tr>
                            ...
                            <td>{{ $row->code }}</td>
                            <td>{{ $row->percentage }} شهر</td>
                            <td>{{ $row->times }}</td>
                            <td style="font-size: 14px;">{{ $row->limit_months !=null ? $row->limit_months ." شهر " : "لم يتم تحديد مدة للإستخدام"  }} </td>
                            <td>{{ $row->category == "all" ?  "كل الاقسام" : $row->cat['name'] }}</td>
                            <td>{{ \Carbon\Carbon::parse($row->expire_at)->format('Y-m-d') }}</td>
