...
@endsection
@section('content')
    <form id="storeCampaign" method="POST" action="{{ route('jobs.update', $result->id) }}"
    ...
    <!-- Page-Title -->
        ...
        <div class="row">
            <div class="col-lg-10 col-sm-offset-1">
                <div class="card-box">
                    <h2 class="header-title m-t-0 m-b-30">تعديل الوظيفة ({{ $result->title }}) </h2>


                    <div class="col-xs-6">
                        <div class="form-group">
                            <label for="userName">عنوان الوظيفة</label>
                            <input type="text" name="title" value="{{ $result->title or old('title') }}"
                    ...
                    <div class="col-xs-6">
                        <div class="form-group">
                            ...
                            <input type="text" name="company" value="{{ $result->company or old('company') }}"
                                   class="form-control" required
                        ...
                        <div class="form-group">
                            ...
                            <div class="input-group">
                                <input type="text" name="start_at"
                                       value="{{ $result->start_at != "" ? $result->start_at->format('Y-m-d') : \Carbon\Carbon::now()->format('Y-m-d') }}"
                        ...
                        <div class="form-group">
                            ...
                            <div class="input-group">
                                <input type="text" name="closed_at"
                                       ...
                                       value="{{ $result->closed_at != "" ? $result->closed_at->format('Y-m-d') : \Carbon\Carbon::now()->format('Y-m-d')}}"
                                       class="form-control datepicker-autoclose" required
                    ...
                    <div class="col-xs-6">
                        <div class="form-group">
                            ...
                            <input type="text" name="price"
                                   value="{{ $result->price or old('price') }}" class="form-control" required
                    ...
                    <div class="col-xs-12">
                        <div class="form-group">
                            ...
                            <textarea name="papers"
                                      ...
                                      data-parsley-trigger="keyup"
                                      data-parsley-required-message="حقل الأوراق المطلوبه إلزامي">{{ $result->papers or old('papers') }}</textarea>
                    ...
                    <div class="col-xs-12">
                        <div class="form-group">
                            ...
                            <textarea name="description" rows="6"
                                      ...
                                      data-parsley-trigger="keyup"
                                      data-parsley-required-message="حقل وصف الوظيفة إلزامي">{{ $result->description or old('description') }}</textarea>
                            <p class="help-block" id="error_userName"></p>
