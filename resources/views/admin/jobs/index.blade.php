...
@section('content')
    ...
    <div class="row">
        <div class="col-sm-12">
            ...
            <h4 class="page-title">مشاهدة الوظائف</h4>
        </div>
    </div>
                    ...
                    @foreach($posts as $key => $row)
                        <tr>
                            ...
                            <td>
                                ...
                                @if($row->applies->count()  > 0)
                                    <a href="#custom-modal{{ $row->id.'--'.$key }}" style="font-size: 13px;"
                                       data-animation="fadein" data-plugin="custommodal"
                                       data-overlaySpeed="200" data-overlayColor="#36404a">مشاهدة</a>

                                    <!-- Modal -->
                                    <div id="custom-modal{{ $row->id.'--'.$key }}" class="modal-demo">
                                        <button type="button" class="close" onclick="Custombox.close();">
                                            <span>&times;</span><span class="sr-only">Close</span>
                                        </button>
                                        <h4 class="custom-modal-title">{{ $row->title }}</h4>
                                        <div class="custom-modal-text">
                                            <table id="datatable-fixed-header2"
                                                ...
                                                @foreach($row->applies as $key => $row)
                                                    <tr>
                            ...
                            <td>
                                <label class="label label-warning">{{ \Carbon\Carbon::parse($row->expire_at)->format('Y-m-d') }}</label>
                            </td>
                            <td>
