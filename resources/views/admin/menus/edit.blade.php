    ...
    <!-- Page-Title -->
        <div class="row">
            <div class="col-lg-8 col-lg-offset-2">
                ...
                <h4 class="page-title">تعديل الإعلان</h4>
            </div>
        </div>
                            ...
                            <div class="col-xs-6">
                                <div class="form-group">
                                    ...
                                    <input type="text" name="name_{{ $locale }}" data-parsley-trigger="keyup" required
                                           ...
                                           id="userName" value="{{ getTextForAnotherLang($model, 'name', $locale) }}"
                        ...
                        <div class="col-xs-6">
                            <div class="form-group">
                                ...
                                <select class="form-control" name="type" required>
                                    <option value="0" @if($model->type == 0) selected @endif>روابط مهمة</option>
                                    <option value="1" @if($model->type == 1) selected @endif>مواقع ذات صلة</option>
                                </select>
                                <p class="help-block" id="error_userName"></p>
                                @if($errors->has('type'))
                                    <p class="help-block">
                            ...
                            <div class="col-xs-12">
                                <div class="checkbox checkbox-custom">
                                    <input id="checkbox-signup" type="checkbox"
                                           name="new_window" value="1" {{ $model->new_window == 1? 'checked' : "" }}>
