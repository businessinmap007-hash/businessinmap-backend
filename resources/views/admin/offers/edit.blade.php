...
@endsection
@section('content')
    <form id="storeCampaign" method="POST" action="{{ route('offers.update', $result->id) }}"
                ...
                <div class="card-box">
                        ...
                        <div class="form-group">
                            ...
                            <select name="product_id" class="form-control" required>
                                ...
                                @foreach($products as $product)
                                    <option value="{{ $product->id }}" {{ $result->product_id  == $product->id ? "selected" : ""}}>{{ $product->name }}</option>
                                @endforeach
                            </select>
                    ...
                    <div class="col-xs-6">
                        <div class="form-group">
                            ...
                            <input type="text" name="started_at" value="{{  $result->started_at or old('started_at') }}" class="form-control"
                                   required
                    ...
                    <div class="col-xs-6">
                        <div class="form-group">
                            ...
                            <input type="text" name="ended_at" value="{{  $result->ended_at or old('ended_at') }}" class="form-control"
                                   required
