    ...
    <div class="row">
        <div class="col-sm-10 col-sm-offset-1">
            <div class="btn-group pull-right m-t-15 ">
                <a href="{{ route('options.create') }}" type="button" class="btn btn-custom waves-effect waves-light"
                   aria-expanded="false">
                <span class="m-l-5">
                    ...
                    @foreach($results as $key => $row)
                        <tr>
                            ...
                            <td>
                                ...
                                <a href="{{ route('options.edit', $row->id) }}"
                                ...
                                <a href="javascript:;" id="elementRow{{ $row->id }}" data-id="{{ $row->id }}"
                                   data-url="{{ route('options.destroy', $row->id) }}"
