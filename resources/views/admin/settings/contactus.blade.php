        ...
        <div class="row">
            <div class="col-lg-8 col-lg-offset-2">
                <div class="card-box">
                    ...
                    <h4 class="m-t-0 m-b-10">تواصل عبر الهاتف</h4>
                    <div class="col-xs-12">
                        <div class="form-group">
                            <label for="userName">عبر الهاتف</label>
                            <input type="text" name="contact_phone"
                                   value="{{ $setting->getBody('contact_phone') }}" class="form-control"
                                   placeholder="عبر الهاتف..."/>
                    ...
                    <h4 class="m-t-30 m-b-10">تواصل عبر البريد الإلكتروني</h4>


                    <div class="col-xs-6">
                        <div class="form-group">
                            <label for="userName">البريد الالكتروني #1</label>
                            <input type="text" name="contact_email_01"
                                   value="{{ $setting->getBody('contact_email_01') }}" class="form-control"
                                   placeholder="البريد الالكتروني #1..."/>
                            <p class="help-block"></p>
                    ...
                    <div class="col-xs-6">
                        <div class="form-group">
                            <label for="userName">البريد الالكتروني #2</label>
                            <input type="text" name="contact_email_02"
                                   value="{{ $setting->getBody('contact_email_02') }}" class="form-control"

                                   placeholder="البريد الالكتروني #2..."/>
                            <p class="help-block"></p>
                    ...
                    <div class="col-xs-6">
                        <div class="form-group">
                            <label for="userName">البريد الالكتروني #3</label>
                            <input type="text" name="contact_email_03"
                                   value="{{ $setting->getBody('contact_email_03') }}" class="form-control"

                                   placeholder="البريد الالكتروني #3..."/>
                            <p class="help-block"></p>
                    ...
                    <div class="col-xs-6">
                        <div class="form-group">
                            <label for="userName">البريد الالكتروني #4</label>
                            <input type="text" name="contact_email_04"
                                   value="{{ $setting->getBody('contact_email_04') }}" class="form-control"

                                   placeholder="البريد الالكتروني #4..."/>
                            <p class="help-block"></p>
                    ...
                    <h4 class="m-t-30 m-b-10 ">وسائل التواصل الاجتماعى</h4>
                    <div class="col-xs-6">
                        <div class="form-group">
                    ...
                    <div class="col-xs-6">
                        <div class="form-group">
                            <label for="userName">تيلجرام</label>
                    ...
                    <div class="col-xs-6">
                        <div class="form-group">
                            <label for="userName">سناب شات</label>
                    ...
                    <div class="col-xs-6">
                        <div class="form-group">
                            <label for="userName">واتس اب</label>
