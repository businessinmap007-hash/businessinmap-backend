    ...
    {{ csrf_field() }}
        ...
        <div class="row">
            <div class="col-sm-8 col-sm-offset-2" >
                ...
                <h4 class="page-title">الأهداف</h4>
            </div>
        </div>
        ...
        <div class="row">
            <div class="col-sm-8 col-sm-offset-2" >
                <div class="card-box">
                    ...
                    <h4 class="header-title m-t-0 m-b-30">الأهداف</h4>
                    ...
                    @foreach (config('translatable.locales') as $locale => $value)
                        <div class="col-xs-12">
                            <div class="form-group">
                                <label for="terms_website"> محتوي الأهداف - {{ $value }} </label>
                                <textarea id="editor{{ $i }}" rows="10" class="form-control msg_body" name="goals_{{ $locale }}">{{ $setting->getBody('goals_'.$locale) }}</textarea>
                            </div>
                        </div>
                        <?php $i++; ?>
                    @endforeach
