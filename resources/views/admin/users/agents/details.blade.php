    ...
    <!-- Page-Title -->
        <div class="row">
            <div class="col-sm-12">
                ...
                <h4 class="page-title">بيانات الوكيل - {{ anotherLangWhenDefaultNotFound($user, 'name') }} </h4>
            </div>
        </div>
                ...
                <div class="card-box">
                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-3 col-xs-12 col-md-6 col-sm-6">
                            ...
                            <p>{{ getTextForAnotherLang($user, 'name', 'ar') }}</p>
                        </div>


                        <div class="col-lg-3 col-xs-12 col-md-6 col-sm-6">
                            <label>اسم الشركة باللغة الانجليزية</label>
                            <p>{{ getTextForAnotherLang($user, 'name', 'en') }}</p>
                        </div>


                        <div class="col-lg-3 col-xs-12 col-md-6 col-sm-6">
                            <label> اسم الوكيل باللغة العربية</label>
                            <p>{{ getTextForAnotherLang($user, 'requirements', 'ar') }}</p>
                        </div>


                        <div class="col-lg-3 col-xs-12 col-md-6 col-sm-6">
                            <label>اسم الوكيل باللغة الانجليزية</label>
                            <p>{{ getTextForAnotherLang($user, 'requirements', 'en') }}</p>
                        </div>
                        ...
                        <div class="col-lg-3 col-xs-12 col-md-6 col-sm-6">
                            ...
                            <p>{{ @optional($user->agentType)->name }}</p>
                        </div>
                        ...
                        <div class="col-lg-4 col-xs-12 col-md-6 col-sm-6">
                            ...
                            @if($user->permit_no ==  0 )
                                ...
                                <p>{{ $user->mina_locations }}  </p>
                            @else
                                <label> التاريخ من/الي:</label>
                                <p>{{ $user->mina_locations }}  </p>
                            @endif
                        </div>
                        ...
                        <div class="col-lg-6 col-xs-12 col-md-6 col-sm-6">
                            <label> عنوان الوكيل باللغة العربية :</label>
                            @if($user->address != "")
                                <p>{{ getTextForAnotherLang($user, 'address', 'ar') }}</p>
                            @else
                                <br/>
                                --
                            @endif
                        ...
                        <div class="col-lg-6 col-xs-12 col-md-6 col-sm-6">
                            <label> عنوان الوكيل باللغة الانجليزية :</label>
                            @if($user->address != "")
                                <p>{{ getTextForAnotherLang($user, 'address', 'en') }}</p>
                            @else
                                <br/>
                                --
                            @endif
                        ...
                        <hr>
                        <div class="col-lg-6 col-xs-12 col-md-6 col-sm-6">
                            <label> وصف الوكيل باللغة العربية :</label>
                            @if($user->description != "")
                                <p>{{ getTextForAnotherLang($user, 'description', 'ar') }}</p>
                            @else
                                <br/>
                                --
                            @endif
                        ...
                        <div class="col-lg-6 col-xs-12 col-md-6 col-sm-6">
                            <label> وصف الوكيل باللغة الانجليزية :</label>
                            @if($user->description != "")
                                <p>{{ getTextForAnotherLang($user, 'description', 'en') }}</p>
                            @else
                                <br/>
                                --
                            @endif
