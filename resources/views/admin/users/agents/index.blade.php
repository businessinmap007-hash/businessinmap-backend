    ...
    <div class="row">
        <div class="col-sm-12">
            <div class="btn-group pull-right m-t-15 ">
                <a href="{{ route('create.agent') }}" type="button" class="btn btn-custom waves-effect waves-light"
                   aria-expanded="false">
                <span class="m-l-5">
            ...
            <div class="card-box table-responsive">
                ...
                <table id="datatable-fixed-header_users" class="table table-striped table-bordered dt-responsive nowrap"
                    ...
                    <tr>
                        ...
                        <th>اسم الشركة</th>
                        <th>اسم الانجليزية</th>
                        <th>اسم الوكيل</th>
                        <th>اسم الوكيل بالانجليزية</th>
                        <th> نوع الوكيل</th>
                        <th>البريد الإلكتروني</th>
                        <th>رقم الجوال</th>
                        <th> نوع الخدمة</th>
                        <th>نوع النشاط</th>
                        <th>عدد الاسابيع / التاريخ من/ الي</th>
                    ...
                    @foreach($users as $row)
                        <tr>
                            ...
                            {{--</a>--}}
                            {{--</td>--}}
                            <td>{{ getTextForAnotherLang($row, 'name', 'ar') }}</td>
                            <td>{{ getTextForAnotherLang($row, 'name', 'en') }}</td>
                            <td>{{ getTextForAnotherLang($row, 'requirements', 'ar')  }}</td>
                            <td>{{ getTextForAnotherLang($row, 'requirements', 'en')  }}</td>
                            <td>{{ @optional($row->agentType)->name }}</td>
                            <td>{{ $row->email }}</td>
                            <td>{{ $row->phone }}</td>
                            <td>
                                @lang('trans.'.$row->seats_no)
                            </td>
                            <td>{{ $row->permit_no  == 0 ?  "عمرة"  : "حج" }}</td>

                            <td>{{ $row->permit_no  == 0   ? $row->mina_locations  : $row->mina_locations }}</td>

                            <td>{{ $row->city ? @$row->city->country->name .' , '. @$row->city->name : "--" }}</td>
                            ...
                            <td>
                                ...
                                <a href="{{ route('get.agent.details', $row->id) }}"
                                ...
                                <a href="{{ route('edit.agent', $row->id) }}"
                                   data-toggle="tooltip" data-placement="top"
                                        ...
                                        <form>
                                            <div class="form-group">
                                                ...
                                                <div>
                                                    ...
                                                    <input type="hidden" id="isSuspendReason{{ $row->id }}" value="1"/>
                                                </div>
                                            </div>
                                            ...
                                            <div class="form-group m-b-0">
                                                <div>
                                                    <button type="submit" data-url="{{ route('user.suspend') }}"
                                                            ...
                                                            data-type="0" class="btn btn-info waves-effect waves-light">
                                                        @lang('trans.suspend')
                                                    </button>
                                                </div>
                                            </div>
