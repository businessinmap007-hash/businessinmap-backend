                ...
                <table id="datatable-fixed-header_users" class="table table-striped table-bordered dt-responsive nowrap"
                    ...
                    @foreach($users as $row)
                        <tr>
                            ...
                            <td>{{ $row->phone }}</td>
                            <td>
                                <a href="{{ route('transactions.index') }}?businessId={{ $row->id }}">
                            ...
                            {{--style="display: {{ $row->suspend_at != "" ? "none" : "block" }}; text-align: center;">--}}
                            {{--<img width="23px" src="{{ request()->root() }}/public/assets/admin/images/ok.png"--}}
                            {{--alt="">--}}
                            {{--</div>--}}

                            {{--<div class="StatusNotActive{{ $row->id }}"--}}
                            {{--style="display: {{ $row->suspend_at != "" ? "block" : "none" }};  text-align: center;">--}}
                            ...
                            <td>
                                ...
                                <a href="{{ route('business.show', $row->id) }}"
