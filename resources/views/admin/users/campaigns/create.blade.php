...
@endsection
@section('content')
    <form id="storeCampaign" method="POST" action="{{ route('store.campaign') }}" enctype="multipart/form-data"
                ...
                <div class="card-box">
                        ...
                        <div class="col-xs-6">
                            ...
                            <div class="col-xs-6">
                                <div class="form-group{{ $errors->has('city_id') ? ' has-error' : '' }}">
                                    ...
                                    <select class="form-control" required name="city_id" id="selectCity" data-parsley-required-message="إختيار المدينة مطلوب">
                    ...
                    <div class="col-xs-12">
                        <div class="form-group{{ $errors->has('mina_locations') ? ' has-error' : '' }}">
                            ...
                            @foreach($locations as $location)
                                ...
                                <label>
                                    <input type="checkbox" name="campaign_location_minaa[]" value="{{ $location }}"
                                           required>
                                    {{ $location }}
                                </label>
                            @endforeach
                    ...
                    <div class="col-xs-4">
                        <div class="form-group">
                            ...
                            <input type="text" name="price_per_person" value="{{ old('price_per_person') }}"
                                   class="form-control" required
                    ...
                    <div class="col-xs-4">
                        <div class="form-group">
                            ...
                            <input type="text" name="seats_no" value="{{ old('seats_no') }}" class="form-control"
                                   required
