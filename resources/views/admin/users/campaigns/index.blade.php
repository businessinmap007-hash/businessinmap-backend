    ...
    <div class="row">
        <div class="col-sm-12">
            <div class="btn-group pull-right m-t-15 ">
                <a href="{{ route('create.campaign') }}" type="button" class="btn btn-custom waves-effect waves-light"
                   aria-expanded="false">
                <span class="m-l-5">
                ...
                <table id="datatable-fixed-header_users" class="table table-striped table-bordered dt-responsive nowrap"
                    ...
                    @foreach($users as $row)
                        <tr>
                            ...
                            <td>{{ $row->email }}</td>
                            <td>{{ $row->phone }}</td>
                            <td>{{ @optional($row->campaignType)->name  }}</td>
                            ...
                            <td>
                                ...
                                <a href="{{ route('get.campaign.details', $row->id) }}"
                                   ...
                                   class="btn btn-icon btn-xs waves-effect  btn-info">
                                    ...
                                    <a href="{{ route('edit.campaign', $row->id) }}"
                                       data-toggle="tooltip" data-placement="top"
                                            ...
                                            <div class="custom-modal-text" style="text-align: right;">
                                                ...
                                                <form>
                                                    <div class="form-group">
                                                        ...
                                                        <div>
                                                    <textarea class="form-control" id="reasonSuspend{{ $row->id }}" required
                                                              rows="5"></textarea>
                                                            <p style="display: none;" id="errorMessageRequired{{ $row->id }}">@lang('trans.required')</p>
