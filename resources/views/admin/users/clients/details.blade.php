                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-3 col-xs-12 col-md-6 col-sm-6">
                                ...
                                <p><a style="text-decoration: underline;"
                                      href="{{ route('sponsors.index') }}?businessId={{ $user->id }}">عرض الإعلانات</a>
                                </p>
                            </div>
                            ...
                            <div class="col-lg-3 col-xs-12 col-md-6 col-sm-6">
                                ...
                                <p><a style="text-decoration: underline;"
                                      href="{{ route('albums.index') }}?businessId={{ $user->id }}">عرض الالبومات</a>
                                </p>
                            </div>
                            ...
                            <div class="col-lg-3 col-xs-12 col-md-6 col-sm-6">
                                ...
                                <div style="display: block">
                                    ...
                                    <a href="#custom-modal-add-balabce" style="text-decoration: underline;"
                                       data-animation="fadein" data-plugin="custommodal"
                                       data-overlaySpeed="200" data-overlayColor="#36404a">إضافة رصيد للعميل</a>
                                    ...
                                    <div id="custom-modal-add-balabce" class="modal-demo">
                                        ...
                                        <div class="custom-modal-text">
                                            <form action="{{ route('transactions.charge', $user->id) }}"
        ...
        <div class="col-sm-12">
            <div class="card-box">
                <div class="row">
                    ...
                    <div class="col-xs-12">
                        <table id="datatable-fixed-header2"
                                ...
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        @if(strlen($post->body) > 50)
                                            <a href="#custom-modal{{ $post->id }}"
                                               data-animation="fadein" data-plugin="custommodal"
                                               data-overlaySpeed="200" data-overlayColor="#36404a">المزيد</a>
                                            ...
                                            @foreach($post->images as $image)
                                                <a data-fancybox="gallery"
                                                   href="{{ $helper->getDefaultImage(asset('public/'.$image->image), request()->root().'/public/assets/admin/images/about_img.jpg') }}">
                                                    <img style="width: 35px; border-radius: 50%; height: 35px; border: 1px dotted #000;"
                                ...
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        @if($job->applies->count()  > 0)
                                            <a href="#custom-modal{{ $job->id.'--'.$key }}" style="font-size: 13px;"
                                               data-animation="fadein" data-plugin="custommodal"
                                               data-overlaySpeed="200" data-overlayColor="#36404a">مشاهدة</a>
