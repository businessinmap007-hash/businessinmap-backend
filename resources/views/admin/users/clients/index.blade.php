    ...
    <div class="row">
        <div class="col-sm-12">
            <div class="btn-group pull-right m-t-15 ">
                <a href="{{ route('create.client') }}" type="button" class="btn btn-custom waves-effect waves-light"
                   aria-expanded="false">
                <span class="m-l-5">
            ...
            <div class="card-box table-responsive">
                ...
                <table id="datatable-fixed-header_users" class="table table-striped table-bordered dt-responsive nowrap"
                    ...
                    <tr>
                        ...
                        <th>اسم المستخدم باللغة العربية</th>
                        <th>اسم المستخدم باللغة الانجليزية</th>
                        ...
                        <tr>
                            ...
                            <td>
                                <a href="{{ route('edit.client', $row->id) }}"
                                   ...
                                   data-original-title="تعديل المستخدم"
