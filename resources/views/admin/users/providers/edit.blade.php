...
@endsection
@section('content')
    <form id="updateProvider" method="POST" action="{{ route('update.provider', $provider->id) }}"
    ...
    <!-- Page-Title -->
        ...
        <div class="row">
            <div class="col-sm-8 col-sm-offset-2">
                <div class="card-box">
                    <h4 class="header-title m-t-0 m-b-30">تعديل مزود خدمة</h4>
                    ...
                    <div class="row">
                            ...
                            <div class="col-xs-6">
                                <div class="form-group">
                                    ...
                                    <input type="text" name="name_{{$locale}}"
                                           value="{{ getTextForAnotherLang($provider, 'name', app()->getLocale()) }}"
                        ...
                        <div class="col-xs-12">
                            <div class="form-group">
                                ...
                                <select class="form-control" name="service_id" required data-parsley-trigger="change"
                                        data-parsley-required-message="إختيار نوع الخدمة إجباري">
                                    <option value="">اختار نوع الخدمة</option>
                                    @foreach($services as $service)
                                        <option value="{{ $service->id }}"
                                                @if($provider->service_id == $service->id) selected @endif>{{ anotherLangWhenDefaultNotFound($service, 'name') }}</option>
                                    @endforeach
                                </select>
                                <p class="help-block" id="error_userName"></p>
                        ...
                        <div class="col-xs-6">
                            <div class="form-group{{ $errors->has('phone') ? ' has-error' : '' }}">
                                ...
                                <input type="text" name="phone" value="{{ $provider->phone or old('phone') }}"
                                       class="form-control numbersOnly  phone" required
                                       placeholder="رقم @lang('maincp.mobile_number')..."
                    ...
                    <div class="col-xs-6">
                        <div class="form-group">
                            ...
                            <input type="text" name="permit_no" value="{{ $provider->permit_no or old('permit_no') }}"
                                   class="form-control" required
                    ...
                    <div class="col-xs-6">
                        <div class="form-group">
                            ...
                            <input type="text" name="price_per_person"
                                   value="{{ $provider->price_per_person or  old('price_per_person') }}"
                                   class="form-control" required
                    ...
                    <div class="col-xs-6">
                        <div class="form-group">
                            ...
                            >{{ getTextForAnotherLang($provider, 'address', app()->getLocale()) }}</textarea>
                            <p class="help-block" id="error_userName"></p>
                    ...
                    <div class="col-xs-6">
                        <div class="form-group">
                            ...
                            >{{ getTextForAnotherLang($provider, 'description', app()->getLocale()) }}</textarea>
                            <p class="help-block" id="error_userName"></p>
                            ...
                            <div class="bg-form">
                                ...
                                <ul class="row m-0 hamla-pics mb-3" style="list-style: none">
                                    @foreach($provider->files as $file)
                                        <li class=" p-0 m-2 "
                                            style="float: right; height: 170px; margin: 5px; position:relative;"
                                            id="image-container{{ $file->id }}">
                                            <a href="javascript:;" class="deleteImageCampaign remove-img"
                                               data-id="{{ $file->id }}">X</a>
                    ...
                    <div class="form-group col-xl-6">
                        <div class="bg-form">
                            <!-- add more images -->
                            <label for="">إضافة صور آخري للخدمة</label>
