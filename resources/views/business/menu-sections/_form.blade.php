...
<div class="a2-card a2-card--section">
    <div class="a2-card-head">
        <div>
            <div class="a2-card-title">{{ __('بيانات القسم') }}</div>
            <div class="a2-card-sub">{{ __('قسم يجمع أصناف المنيو المتشابهة.') }}</div>
        </div>
    </div>
    ...
    <div class="a2-form-grid">
        <div class="a2-form-group">
            ...
            <input class="a2-input" id="name_ar" name="name_ar" value="{{ old('name_ar', $row->name_ar ?? '') }}" placeholder="{{ __('أطباق رئيسية') }}" required>
        </div>
