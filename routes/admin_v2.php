...
Route::prefix('admin')->name('admin.')->group(function () {
    ...
    Route::middleware(['admin.v2'])->group(function () {
        ...
        // =========================
                ...
                //     Route::get('{tx}', [FinancialController::class, 'show'])->name('show');
                // });
        ...
        Route::prefix('wallet-transactions')->name('wallet-transactions.')->group(function () {
            ...
            // IMPORTANT: put this BEFORE {walletTransaction}
        ...
        // =========================
        // Wallet Note Templates (resource)
        // =========================
